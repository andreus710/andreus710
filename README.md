...
Me motiva formar parte de un entorno colaborativo donde pueda aportar valor desde el primer día. Actúo con iniciativa, responsabilidad y un fuerte compromiso con el aprendizaje continuo.

---

### 🚀 Mi Experiencia

He aplicado mis conocimientos en Python, SQL, Power BI y Azure en diversos proyectos académicos, incluyendo:
* Simulaciones de procesos.
* Análisis de datos para encontrar rutas seguras.
* Sistemas de gestión de inventario.
* Desarrollo de chatbots y soluciones automatizadas.

### 🌱 Actualmente estoy...
* Profundizando mis conocimientos en **Azure**, especialmente en servicios de IA para la creación de chatbots 🤖.
* Mejorando mis habilidades de visualización con **Power BI** 📊.
* Explorando el desarrollo web full-stack con **Java (Spring)** y **JavaScript (React)** 🌐.

---

### 🛠️ Mi Stack Tecnológico

Aquí están las tecnologías y herramientas con las que trabajo:
...
#### Tecnologías, Cloud y Herramientas
